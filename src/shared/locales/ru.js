export const dict = {
  ...
  admin: {
    headerTitle: "АКУПКИ",
    nav: {
      ledgerTooltip: "Журнал расходов",
      saveTooltip: "Зафиксировать",
      formTooltip: "Вернуться к списку",
      newExpenseTooltip: "Добавить новый расход",
    ...
    expenseForm: {
      ...
      errors: {
        ...
        payer: "Это поле обязательно для заполнения",
        category: "Выберите категорию",
        name: "Это поле обязательно для заполнения",
      },
    },
    ledger: {
      searchPlaceholder: "Поиск по имени, категории или комментарию...",
      totalLabel: "ИТОГО",
      tableTitle: "Список расходов",
      emptyFilter: "Нет расходов, соответствующих фильтру",
      cols: {
        date: "Дата",
        category: "Категория",
        name: "Наименование",
      ...
      deleteModal: {
        ...
        body: "Вы уверены, что хотите удалить этот расход?",
        confirm: "Удалить",
      },
    },
    draftModal: {
      title: "С возвращением!",
      body1: "У Вас остался несохранённый расход.",
      body2: "Хотите продолжить его заполнение или начать всё заново?",
      restart: "Начать заново",
      continue: "Продолжить",
    },
    leaveModal: {
      title: "Покинуть форму?",
      body: "У Вас остался несохранённый расход. Хотите сбросить данные и выйти?",
      discardAndLeave: "Выйти",
      cancel: "Отмена",
    },
  },
};
