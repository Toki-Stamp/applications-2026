export const dict = {
  options: {
    ...
    globalHints: {
      ...
      activeFilters:
        "Активные фильтры и кнопка сброса находятся на панели внизу",
      filterModePrefix: "Нажимайте на иконку ",
      filterModeSuffix: " на панели внизу, чтобы скрыть лишние строки",
      pinPrefix: "Нажимайте на иконку ",
      pinSuffix: " в заголовке столбца, чтобы закрепить его",
      cellFilter:
        "Нажимайте на города и время прямо в ячейках таблицы для быстрой фильтрации",
      select: "Нажимайте на строки, чтобы выделить и не потерять нужных людей",
      hotkeysPrefix: "Используйте ",
      hotkeysMiddle: " для выбора нескольких строк, и ",
      hotkeysSuffix: " для диапазона",
    },
  },
  errors: {
    radio: (label) => [
    ...
    submitError: {
      ...
      types: {
        network: {
          ...
          body: "Похоже, пропало подключение к интернету или запрос заблокирован (например, VPN или AdBlock). Пожалуйста, проверьте связь и попробуйте ещё раз",
        },
        server: {
          title: "Ошибка на сервере!",
          body: "Что-то пошло не так на нашей стороне. Не волнуйтесь, ваш черновик сохранён! Попробуйте отправить заявку чуть позже",
        },
        logic: {
          title: "Сбой при отправке!",
          bodyPrefix: "Сервер отказал в приеме заявки. Возможная причина: ",
        },
        setup: {
          title: "Техническая неполадка!",
          body: "Форма не настроена для отправки данных. Пожалуйста, свяжитесь с организаторами",
        },
        unknown: {
          title: "Неизвестная ошибка!",
          bodyPrefix: "Что-то пошло не так: ",
        },
      },
    },
    draft: {
  ...
  steps: {
    ...
    transportation: {
      ...
      commentLabel: "Комментарий к транспорту",
    ...
    provisions: {
      ...
      unifiedHint2: [
        ...
        { text: " и выберите " },
        {
          text: "дифференцированные условия",
          bold: true,
          highlight: true,
          upper: true,
        },
      ...
      diffHint: [
        ...
        { text: " с " },
        {
          text: "дифференцированными условиями",
          bold: true,
          highlight: true,
          upper: true,
        },
      ...
      commentLabel: "Комментарий к питанию",
      commentPlaceholder: "Напишите здесь всё, что считаете важным...",
      commentHint: `"аллергия на орехи", "я веган", "не пью крепкий алкоголь" или "пью только крафтовое пиво"`,
    },
    accommodation: {
      title: "Проживание",
      typeLabel: "Потребность в проживании",
      nightsLabel: "Укажите ночевки",
      commentTitle: "Дополнительно по проживанию",
      ...
      unifiedHint2: [
        {
          text: "Если кому-то из участников требуется иные условия проживания или кто-то размещается самостоятельно, пожалуйста, вернитесь на шаг ",
        },
        { text: "формат участия", bold: true, highlight: true, upper: true },
        { text: " и выберите " },
        {
      ...
      diffHint: [
        ...
        {
          text: " Вы можете настроить индивидуальные параметры проживания для себя и каждого гостя",
        },
      ],
      forApplicant: (name) => `Для ${name}`,
      forGuest: (name) => `Для ${name}`,
