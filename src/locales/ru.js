export const dict = {
  options: {
    ...
    globalHints: {
      filterPrefix: "Нажимайте на иконки транспорта (",
      filterSuffix: ") и дни в шапке, чтобы подсветить нужных участников",
      select: "Нажимайте на строки таблицы, чтобы выделить участников",
      multiSelectPrefix: "Удерживайте ",
      multiSelectSuffix: ", чтобы выделить сразу несколько строк",
      rangeSelectPrefix: "Удерживайте ",
      rangeSelectSuffix: ", чтобы выделить диапазон между строками"
    },
  },
  errors: {
    radio: (label) => [
